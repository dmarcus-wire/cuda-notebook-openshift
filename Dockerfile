...
RUN curl -s -L https://nvidia.github.io/nvidia-docker/rhel8.3/nvidia-docker.repo | sudo tee /etc/yum.repos.d/nvidia-docker.repo

# Now, install the NVIDIA runtime
RUN yum clean expire-cache && yum install -y nvidia-container-toolkit
